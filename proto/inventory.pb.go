...
const file_proto_inventory_proto_rawDesc = "" +
	...
	"\rStockResponse\x12!\n" +
	"\fis_available\x18\x01 \x01(\bR\visAvailable2L\n" +
	"\tInventory\x12?\n" +
	"\n" +
	"CheckStock\x12\x17.inventory.StockRequest\x1a\x18.inventory.StockResponseB\x13Z\x11./proto;inventoryb\x06proto3"
